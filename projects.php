...
<div id="container" class="container">
  <div class="back"><a href="index.php"><i class="fas fa-caret-left"></i>Back</a></div>
  ...
  <input class="search" type="text" name="str" placeholder="Search for projects">
  <input class="search-btn" type="submit" name="submit" value="🔎"></i></input>
 </form>
<?php
...
$qry="SELECT * from projects where name like '%$str%' or tech like '%$str%' or aoi like '%$str%'";
...
if(mysqli_num_rows($data)>0)
{
 while($result=mysqli_fetch_array($data))
 {
  ...
  <li class="project">
   ...
   <button type="button" class="btn btn-primary"><a target="_self" href="project_details.php?id=<?php  echo $result['id'];?>" > View More</a></button>
